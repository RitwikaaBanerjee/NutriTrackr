...
export default function ProtectedRoute() {
  ...
  return (
    <div className="min-h-screen relative"
      ...
      {/*
        IMPORTANT: The Navbar is position:fixed and 72px tall.
        We use a spacer div to push content below it, NOT padding.
        This is the most reliable approach.
      */}
      <div style={{ height: '72px' }} aria-hidden="true" />

      <main className="relative" style={{ zIndex: 1, minHeight: 'calc(100vh - 72px)' }}>
        <Outlet />
      </main>
    </div>
  );
